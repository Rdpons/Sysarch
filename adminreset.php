		...
		<table class="user-table">			
			...
			<?php
				while ($row = mysqli_fetch_assoc($result)) {
					...
					echo "<input type='password' name='new_password' placeholder='Enter New Password' onclick='clearPlaceholder(this)' onfocusout='restorePlaceholder(this)' data-placeholder='Enter New Password' required>";
					echo "<br>";
					echo "<button type='submit' class='button'>Edit Password</button>";
					echo "</form>";
					echo "</td>";
					echo "</tr>";
				}
