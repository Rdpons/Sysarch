...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO reserve (pcnum, purpose, lab, resdate, restime, idno, session, firstName, middleName, lastName) 
                    VALUES ('$pcnum', '$purpose', '$lab', '$resdate', '$restime', '$idno', '$session', '$firstName', '$middleName', '$lastName')";

    if (mysqli_query($con, $insertQuery)) {
        echo "<script>alert('Reservation successful!'); window.location.href='reserve.php';</script>";
    } else {
