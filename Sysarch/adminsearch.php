...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reset_session'])) {
    ...
    $resetQuery = "UPDATE users SET session = 30 WHERE idno = '$reset_id'";
    $resetResult = mysqli_query($con, $resetQuery);
    if (!$resetResult) {
        die('Error resetting session: ' . mysqli_error($con));
    }
	...
	<style>
		...
		* {
		...
		@media screen and (max-width: 576px) {
            ...
            .remaining_sessions p{
                margin-left: 20px;
                font-size: 15px;
            }
			.remaining_sessions input[type="number"] {
                width: 6%; 
                padding: 10px; 
                font-size: 16px; 
                border: 1px solid #ccc;
			...
			<div class="user-info-row">
                ...
                <?php if(isset($student)) :?>
                    <div class="user-info-item">
                        ...
                        <div class="value"><?php echo $idno;?></div> 
                        </div> 
                    <div class="user-info-item">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="remaining_sessions">
                            <p>Remaining Sessions: <span class="red-text"></span></p>
                            <form>
                            <input type="number" name="session" value="<?php echo $session;?>" disabled>
                            <br>
                            <button type="submit" name="sitin" class="sit-in-btn">Sit in</button>
                        </form>
                    </div>
                <?php endif;?>
        </main>
